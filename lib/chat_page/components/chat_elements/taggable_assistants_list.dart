...
class TaggableAssistantsList extends GetView<PupauChatController> {
  const TaggableAssistantsList({super.key});

  @override
  Widget build(BuildContext context) {
    Theme.of(context);
    final MyMentionTagTextEditingController textController =
      ...
      return filteredAssistants.isEmpty
          ...
          : Container(
              ...
              constraints: BoxConstraints(
                maxHeight: DeviceService.height * 0.35,
              ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  bool isLast = index == 0;
                  bool isAlreadyTagged = controller
