      ...
      slivers: [
        ...
        Obx(() {
          ...
          bool showDate(DateTime date) =>
              ...
              date.day != controller.conversation.value?.createdAt.day;
          return SliverList(
              ...
              (context, index) {
                ...
                if (isLastIndex || isDifferentDay) {
                  ...
                  return Column(
                    ...
                    children: [
                      if (showDate(date)) ChatDateContainer(date: date),
        ...
        Obx(() {
          if (controller.isLoadingMessageActive()) {
            return const SliverToBoxAdapter(child: ChatLoadingMessage());
          }
