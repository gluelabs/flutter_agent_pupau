...
class MyMentionTagTextField extends TextField {
  MyMentionTagTextField({
    super.key,
    ...
    super.magnifierConfiguration,
            ...
            onChanged: (value) {
              if (controller is MyMentionTagTextEditingController?) {
                try {
  ...
  void _setControllerProperties(
      MyMentionTagTextEditingController? mentionController,
...
class MyMentionTagTextFormField extends TextFormField {
