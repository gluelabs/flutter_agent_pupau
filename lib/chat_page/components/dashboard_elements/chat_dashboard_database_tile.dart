...
/// One-line native database / spreadsheet tool row for the chat dashboard.
class ChatDashboardDatabaseTile extends GetView<ChatDashboardController> {
  const ChatDashboardDatabaseTile({
    super.key,
        ...
        child: Row(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Icon(Symbols.database, size: isTablet ? 20 : 18),
            ),
          ],
        ),
      ),
