...
/// `.md` files and images can be opened in the canvas (note editor / image
/// preview respectively) — other formats are shown as non-interactive
/// entries (tap disabled, muted appearance).
class ChatDashboardAttachmentTile extends GetView<ChatDashboardController> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isMarkdown = attachment.extension.toLowerCase() == 'md';
    final bool isImage =
        AttachmentService.getAttachmentCategory(attachment) ==
        AttachmentCategory.image;
    final bool canOpen = isMarkdown || isImage;
    final bool isEditable = isMarkdown && attachment.isEditable;
