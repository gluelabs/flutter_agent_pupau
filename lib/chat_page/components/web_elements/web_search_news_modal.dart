...
void showWebSearchNewsModal(List<WebSearchNews> news) {
  WoltModalSheetPage page(BuildContext modalSheetContext) {
    return WoltModalSheetPage(
      ...
      hasTopBarLayer: true,
      topBarTitle: ModalTopBarTitle(title: Strings.news.tr),
      isTopBarLayerAlwaysVisible: true,
      child: Padding(
        padding: const EdgeInsets.only(top: 12, bottom: 8),
        child: WebSearchNewsList(news: news, hideHeader: true),
      ),
    );
  }
